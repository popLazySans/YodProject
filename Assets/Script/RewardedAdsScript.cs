...
public class RewardedAdsScript : MonoBehaviour, IUnityAdsLoadListener, IUnityAdsShowListener
{
    ...
    public TMP_Text Slained;
    public Canvas canvas;
    public GameObject mainCam;
    public GameObject ADcam;

    public GameObject enemySoundSource;
    ...
    void Start()
    {
        enemyDeadAudio = enemySoundSource.GetComponent<AudioSource>();
        ADcam.SetActive(false);
    ...
    public void OnUnityAdsShowComplete(string adUnitId, UnityAdsShowCompletionState showCompletionState)
    {
        if (adUnitId.Equals(_adUnitId) && showCompletionState.Equals(UnityAdsShowCompletionState.COMPLETED))
        {
            ...
            canvas.GetComponent<pauseManager>().Pause();
    ...
    IEnumerator Reward()
    {
        ...
        ADcam.SetActive(true);
        yield return new WaitForSeconds(3f);
        enemyDeadAudio.Play();
        Destroy(enemy);
        Current.Score -= 1;
        yield return new WaitForSeconds(0.5f);
        Slained.SetText("Slained!!!");
